...
#     Número de cuotas en mora: Es el número de cuotas que ha dejado de pagar el cliente hasta la fecha. Se reportará 1, cuando el    cliente que deba pagar dos cuotas para no entrar en cancelación, solamente abone una cuota y deje la cuota en mora. 
    ...
    def init(self):
        ...
        subtmpl.recurring_rule_count / subtmpl.recurring_interval as number_of_plan_installments,
        '4'::text as total_installments,
        '1'::text as number_of_installments_arrears        
...
#         where date_start BETWEEN '2021-05-20' AND '2021-05-26'
    ...
    def _cron_send_email_collection_file(self):
        ...
        if 'start_date2' in locals():            
            ...
            with open('src/user/web_sale_extended/static/src/collections_files/collection.csv', 'w', encoding='utf-8', newline='') as file, open('src/user/web_sale_extended/static/src/collections_files/collection2.csv', 'w', encoding='utf-8', newline='') as file2:
            ...
            with open ('src/user/web_sale_extended/static/src/collections_files/collection.csv', 'rb') as archivo, open ('src/user/web_sale_extended/static/src/collections_files/collection2.csv', 'rb') as archivo2:
            ...
            with open ('src/user/web_sale_extended/static/src/collections_files/collection.csv', 'w', encoding='utf-8', newline='') as file:
                writer = csv.writer(file, delimiter=',')
                writer.writerows(data)

            with open ('src/user/web_sale_extended/static/src/collections_files/collection.csv', 'rb') as archivo:
                encoded = base64.b64encode(archivo.read())        
